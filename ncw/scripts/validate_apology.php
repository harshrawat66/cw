...
$bd = "This is to inform you that i do apologize for" . $_SESSION['reason']. " <br><a href='127.0.0.1/ncw/scripts/accept.php?tag=accept&id=". $r ."'>ACCEPT</a><br><a href='127.0.0.1/ncw/scripts/reject.php?tag=reject&id=". $r ."'>REJECT</a>"  ;
