...
$bd = "This is to inform you that i will not be attending college form " . $_SESSION['pdfrom'] ." to " . $_SESSION['pdto'] . " <br><a href='127.0.0.1/ncw/scripts/accept.php?tag=accept&id=". $r ."'>ACCEPT</a><br><a href='127.0.0.1/ncw/scripts/reject.php?tag=reject&id=". $r ."'>REJECT</a>"  ;
$fl = "leave_application.php" ;
